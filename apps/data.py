...
def app():
    ...
    tahunx = frame3['tahun'].unique()
    negaraminyak2 = frame3['kode_negara'].unique()
    tahunminyak = frame3['tahun'].unique()
    minyaktahun = st.multiselect('Tahun', options=tahunminyak,default=tahunminyak)
    minyak_selection2 = st.multiselect('Negara:',options=negaraminyak2,default=negaraminyak2)
    ...
    bar_sum = px.bar(
        frame3,x='produksi',y=frame3.index,
            orientation="h",
